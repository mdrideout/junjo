...
More advanced examples can be found in the `examples directory <https://github.com/mdrideout/junjo/tree/master/sdks/python/examples>`_ of the Junjo repository.
