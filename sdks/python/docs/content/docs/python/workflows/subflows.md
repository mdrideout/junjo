...
- [Base Example Graph With Subflow](https://github.com/mdrideout/junjo/blob/master/sdks/python/examples/base/src/base/sample_workflow/graph.py)
...
<img src="/docs-assets/generated/python/subflow-graphviz-visual.png" alt="A screenshot of a Junjo workflow graph&#x27;s Graphviz visual, featuring a subflow" style="max-width: 100%; width: 600px; display: block; margin-inline: auto" />
