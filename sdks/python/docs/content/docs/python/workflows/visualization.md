...
<img src="/docs-assets/generated/python/junjo-screenshot-graphviz.png" alt="Basic example of a Junjo workflow graph rendered by Graphviz" style="max-width: 100%; width: 75%; display: block; margin-inline: auto" />
...
1. **Graphviz System Installation:**
   ...
   For other systems, please refer to the official [Graphviz download page](https://graphviz.org/download/).
...
```python title="visualize_mermaid.py"
