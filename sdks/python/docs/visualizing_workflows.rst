...
--------------------------------------
For real-time observation and debugging of workflow executions, Junjo integrates seamlessly with OpenTelemetry. The optional, open-source `Junjo AI Studio <https://github.com/mdrideout/junjo/tree/master/apps/studio>`_ ingests these telemetry traces and provides a web interface to:
