---
title: "Junjo AI Studio Deployment"
---
<!-- migrated-from: sdks/python/docs/deployment.rst; source-hash: sha256:85252c1f4ea56080a20d0b20803dfd09abc6e58560852704ab980851de3daca9 -->
...
For a minimal, flexible Docker Compose setup that you can customize for your specific infrastructure needs, use the [Junjo AI Studio Minimal Build Template](https://github.com/mdrideout/junjo-ai-studio-minimal-build).
...
For a complete production Junjo AI Studio deployment example to a fresh virtual machine using Docker Compose, Caddy reverse proxy, and automatic HTTPS, see the [Junjo AI Studio Deployment Example](https://github.com/mdrideout/junjo-ai-studio-deployment-example).
