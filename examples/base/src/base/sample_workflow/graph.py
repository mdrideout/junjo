...
from base.sample_workflow.sample_subflow.graph import create_sample_subflow_graph
...
def create_sample_workflow_graph() -> Graph:
    """
    ...
    sample_subflow = SampleSubflow(
        graph_factory=create_sample_subflow_graph,
