...
def create_work_response_workflow_prompt(
...
RESPONSE DIRECTIVE:
You need to create a work-related response. Analyze the context for anything you have
previously disucssed about your own work history.
This is to continue building your personal narrative for future chats.
Come up with new work history if you have not previously discussed it.
